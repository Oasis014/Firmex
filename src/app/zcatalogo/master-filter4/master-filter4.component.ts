...
const data: any = require('../../shared/data/genero.json');

@Component({
    selector: 'app-master-filter4',
    templateUrl: './master-filter4.component.html',
    styleUrls: ['./master-filter4.component.scss']
})

export class Mast4FilterComponent {
    rows = [];
    selected: any[] = [];
    temp = [];
